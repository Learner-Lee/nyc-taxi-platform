...
- [STAGE 12](docs/STAGE_12_Streamlit司机应用.md) — Streamlit 司机端推荐应用（纯 Python + PG 覆盖索引）
...
- [x] **STAGE 12**: Streamlit 司机应用 — 纯 Python 司机接单推荐 App(连 PG + 覆盖索引,st.cache_data 缓存),五类用户全覆盖闭环
- [ ] STAGE 13: 项目复盘与简历输出
- [ ] STAGE 07: DWS 层与查询优化
